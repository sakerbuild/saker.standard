...
@SakerTest
public class WildcardDirectoryPrepareTest extends RepositoryLoadingVariablesMetricEnvironmentTestCase {
	...
	protected void runTestImpl() throws Throwable {
		...
		assertEquals(files.getAllBytes(PATH_BUILD_DIRECTORY.resolve("std.dir.prepare/default/f1.txt")).toString(),
				"f1");
		assertEquals(files.getAllBytes(PATH_BUILD_DIRECTORY.resolve("std.dir.prepare/default/dir/f2.txt")).toString(),
				"f2");
